/* prebid.js v8.52.0
Updated: 2024-07-01
Modules: adagioBidAdapter, adgenerationBidAdapter, adtargetBidAdapter, adyoulikeBidAdapter, amxBidAdapter, appnexusBidAdapter, atsAnalyticsAdapter, consentManagement, consentManagementUsp, conversantBidAdapter, currency, criteoBidAdapter, gdprEnforcement, gptPreAuction, holidBidAdapter, id5IdSystem, identityLinkIdSystem, invibesBidAdapter, ixBidAdapter, kueezRtbBidAdapter, livewrappedBidAdapter, medianetAnalyticsAdapter, medianetBidAdapter, minutemediaBidAdapter, nextMillenniumBidAdapter, openxBidAdapter, priceFloors, pubmaticBidAdapter, pubProvidedIdSystem, pubxaiAnalyticsAdapter, relevantdigitalBidAdapter, richaudienceBidAdapter, riseBidAdapter, rubiconBidAdapter, seedtagBidAdapter, sharedIdSystem, sovrnBidAdapter, stroeerCoreBidAdapter, teadsBidAdapter, tripleliftBidAdapter, unifiedIdSystem, userId, vidazooBidAdapter, yandexBidAdapter */
...
(self.pbjsChunk=self.pbjsChunk||[]).push([[55],{4371:function(u,n,r){r.d(n,{_:function(){return f}});var t,f=(t={"<":"\\u003C",">":"\\u003E","/":"\\u002F","\\":"\\\\","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\0":"\\0","\u2028":"\\u2028","\u2029":"\\u2029"},function(u){return u.replace(/[<>\b\f\n\r\t\0\u2028\u2029\\]/g,(function(u){return t[u]}))})}}]);
...
(self.pbjsChunk=self.pbjsChunk||[]).push([[7635],{9957:function(n,r,t){t.d(r,{Nh:function(){return e}});var u=t(8640);function e(n,r,t){var e=!(arguments.length>3&&void 0!==arguments[3])||arguments[3];if(r===t)return n;var c=n;try{c=(0,u.R)().convertCurrency(n,r,t)}catch(n){if(!e)throw n}return c}}}]);
...
(self.pbjsChunk=self.pbjsChunk||[]).push([[3434],{6564:function(e,r,i){var n=i(2982),a=i(885),t=i(8640),s=i(6475),o=i(4358),u=i(265),d=i(5339),p=i(4679),c=i(5164),m=i(919),f=i(5840),l="conversant",v=(0,c.df)({gvlid:24,bidderCode:l});function b(e,r){var i=function(e){var r=null;e.userId&&e.userId.pubcid?r=e.userId.pubcid:e.crumbs&&e.crumbs.pubcid&&(r=e.crumbs.pubcid);if(!r){r=function(e){var r;try{if(!(r=v.getCookie(e))){var i=v.getDataFromLocalStorage("".concat(e,"_exp"));(""===i||i&&new Date(i).getTime()-Date.now()>0)&&(r=(r=v.getDataFromLocalStorage(e))?decodeURIComponent(r):r)}(0,o.d8)(r)&&"{"===r.charAt(0)&&(r=JSON.parse(r))}catch(e){(0,o.H)(e)}return r}((0,o.An)("pubcid_name",e.params)||"_pubcid")}return r}(e);i&&(0,s.N)(r,"user.ext.fpc",i)}var y=(0,m.x)({context:{netRevenue:!0,ttl:300},request:function(e,r,i,n){var a=e(r,i,n);if(a.at=1,n.bidRequests){var t=n.bidRequests[0];!function(e,r){e.params.site_id&&(r.site&&(r.site.id=e.params.site_id),r.app&&(r.app.id=e.params.site_id))}(t,a),b(t,a)}return a},imp:function(e,r,i){var n=e(r,i),a={secure:1,bidfloor:h(r)||0,displaymanager:"Prebid.js",displaymanagerver:"8.52.0"};return T(r.params.tag_id,a,"tagid"),(0,o.Ee)(n,a,n),n},bidResponse:function(e,r,i){if(r.price){if(!i.mediaType&&i.bidRequest.mediaTypes){var n=Object.keys(i.bidRequest.mediaTypes),t=(0,a.Z)(n,1)[0];Object.values(f.e).includes(t)&&(i.mediaType=t)}var s=e(r,i);return s}},response:function(e,r,i,n){var a=e(r,i,n);return a},overrides:{imp:{banner:function(e,r,i,n){i.mediaTypes&&!i.mediaTypes.banner||(i.params.position&&(0,o.Ee)(i,{mediaTypes:{banner:{pos:i.params.position}}}),e(r,i,n))},video:function(e,r,i,n){var a,t,s,u,d;if(!i.mediaTypes||i.mediaTypes.video){var p={};T(null===(a=i.params)||void 0===a?void 0:a.position,p,"pos"),T(null===(t=i.params)||void 0===t?void 0:t.mimes,p,"mimes"),T(null===(s=i.params)||void 0===s?void 0:s.maxduration,p,"maxduration"),T(null===(u=i.params)||void 0===u?void 0:u.protocols,p,"protocols"),T(null===(d=i.params)||void 0===d?void 0:d.api,p,"api"),r.video=(0,o.Ee)(p,r.video),e(r,i,n)}}}}}),g={code:l,gvlid:24,aliases:["cnvr","epsilon"],supportedMediaTypes:[p.Mk,p.pX],isBidRequestValid:function(e){if(!e||!e.params)return(0,o.yN)("conversant: Missing bid parameters"),!1;if(!(0,o.d8)(e.params.site_id))return(0,o.yN)("conversant: site_id must be specified as a string"),!1;if(function(e){return"video"===e.mediaType||!!(0,u.Z)(e,"mediaTypes.video")}(e)){var r=e.params.mimes||(0,u.Z)(e,"mediaTypes.video.mimes");if(r){if(!(0,o.kJ)(r)||!r.every((function(e){return(0,o.d8)(e)})))return(0,o.yN)("conversant: mimes must be an array of strings"),!1}else(0,o.yN)("conversant: mimes should be specified for videos")}return!0},buildRequests:function(e,r){var i=y.toORTB({bidderRequest:r,bidRequests:e});return{method:"POST",url:R(e[0]),data:i}},interpretResponse:function(e,r){return y.fromORTB({request:r.data,response:e.body})},getUserSyncs:function(e,r,i,a){var t={},s=[];if(i&&(t.gdpr=i.gdprApplies?1:0,t.gdpr_consent=encodeURIComponent(i.consentString||"")),a&&(t.us_privacy=encodeURIComponent(a)),r&&r.ext){var u=[{urls:r.ext.fsyncs,type:"iframe"},{urls:r.ext.psyncs,type:"image"}].filter((function(r){return r.urls&&("iframe"===r.type&&e.iframeEnabled||"image"===r.type&&e.pixelEnabled)})).map((function(e){return e.urls.map((function(r){var i=(0,o.en)(r);return(0,o.Ee)(i.search,t),0===Object.keys(i.search).length&&delete i.search,{type:e.type,url:(0,o.Q2)(i)}})).reduce((function(e,r){return e.concat(r)}),[])})).reduce((function(e,r){return e.concat(r)}),[]);s.push.apply(s,(0,n.Z)(u))}return s}};function T(e,r,i){e&&(r[i]=e)}function h(e){var r=(0,o.An)("bidfloor",e.params);if(!r&&(0,o.LQ)(e.getFloor)){var i=e.getFloor({currency:"USD",mediaType:"*",size:"*"});(0,o.PO)(i)&&!isNaN(i.floor)&&"USD"===i.currency&&(r=i.floor)}return r}function R(e){var r="https://web.hb.ad.cpe.dotomi.com/cvx/client/hb/ortb/25";return e.params.white_label_url&&(r=e.params.white_label_url),r}(0,d.dX)(g),(0,t.z)("conversantBidAdapter")}},function(e){e.O(0,[5823,5279,9270],(function(){return r=6564,e(e.s=r);var r}));e.O()}]);
